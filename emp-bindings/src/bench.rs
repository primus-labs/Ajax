...
pub fn bench_triples_main() {
    ...
    let ip_list: Vec<String> = (0..total_party).map(|_| "127.0.0.1".to_string()).collect();
    ...
    for party in 0..total_party {
        ...
        handles.push(thread::spawn(move || {
            ...
            let res = generate_triples(party, total_party, base_port, &ip_list_clone, num_triples);
